// Reusable AuraAI insight engine for AuraFinance
...
export function getVestInsights(userId) {
  ...
  return {
    ...
    insights: [
      ...
      `AuraAI suggests investing in tech stocks for long-term growth.`
    ]
  };
}
...
export function getOverallInsights(userId) {
  ...
  return {
    ...
    insights: [
      ...
      `AuraAI recommends transferring $${Math.min(500, bank.totalBalance * 0.1)} from bank to investments.`,
