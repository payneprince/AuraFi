...
export function Hero() {
  return (
    <WavyBackground containerClassName="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center z-10">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12 animate-scale-in" style={{ animationDelay: '0.4s' }}>
          <button
            ...
            className="px-8 py-4 rounded-full bg-gradient-to-r from-teal to-magenta text-white text-lg font-semibold hover:opacity-90 hover:shadow-xl transition-all duration-300 shadow-lg">
            Get Started Free
          </button>
          <button
            onClick={() => document.getElementById('products')?.scrollIntoView({ behavior: 'smooth' })}
            className="px-8 py-4 rounded-full border-2 border-white/20 text-lg font-semibold hover:bg-white/10 hover:shadow-lg transition-all duration-300 flex items-center gap-2 backdrop-blur-sm">
